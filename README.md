...
> **Distribution repository.** This is the GitHub Marketplace listing of the `noru-ci`
...
>
> `uses: noru-tech/noru-ci-action@v0.7.4` and
> `uses: noru-tech/noru-grc-engineering/.github/actions/noru-ci@v0.7.4`
...
the [toolkit README](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.4/README.md#pieces).
...
are in [`docs/ci-mode.md`](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.4/docs/ci-mode.md).
...
| `exit-code` | The orchestrator's exit code; the table is in [`docs/ci-mode.md`](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.4/docs/ci-mode.md#exit-codes) |
...
[changelog](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.4/CHANGELOG.md).
